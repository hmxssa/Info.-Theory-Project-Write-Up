    ...
    <br><br>
      ...
      <table border=0 width="850"> 
        <tr>
          ...
          <p> 
          &nbsp;&nbsp;&nbsp;<font size="+3" color="#1A5276"><b>Space Strike</b></font><br>
          <hr>
        </p>
      ...
      <tr>
        ...
        <font size="+1" color="#17202A"><b><i>Skills</i></b></font>
          <blockquote>
          ¬ Project Planning<br>
          ¬ Game Design<br>
        ...
        <td valign="top" colspan="4">
          ...
          of knowledge and skill in the project product. As such, I chose to do a 2d game of a player navigating 
          through falling stars to avoid losing.
<br>
          </blockquote><br>
        ...
        <tr>
          <td>&nbsp;</td>
          <td valign="top">
          <font size="+2" color="#1A5276"><b><i>Skill Descriptions</i></b></font><br>
          <blockquote>
          <font size="+1" color="#1A5276"><b><i>Control Flow & Info. Theory</i></b></font><br>
          <blockquote>
         Control Flow is visible everywhere in my project. Sequence, iteration, and conditional statements all 
         play a very crucial role in running my codes successfully.<br> 
         <b>Sequence</b> - My code runs in an order from the top to bottom. It starts by the imports, making sure that 
         the program I’m using is in, the clock as it supports my time variable, and randomization. I also include 
         the variables I use throughout the code such as the height and width of the screen, player, star and even the velocity too.<br>  
         <b>Iteration</b> - The while run loop is an example used for iteration in my game. This loop continues to run as long as
         ...
         practice even more to pass it. This is through the random import.<br> 
         <b>Selection/Conditional</b> - The use of selection with conditional statements is present in the draw, main, and star loops. Multiple 
         functions such as if to check for key pieces being used and if one certain one is pressed then a specific function will happen. 
         This happens in the code “if keys [pygame.K_LEFT]. This is also expressed in the if, else, and elif statements. They are used 
         to execute a certain code among three actions that a player may choose/perform. It's mainly visible in the star movement loop,
         as it reacts if the star moves or collides with the player. If the condition is true, then the variable will perform the function
         of the player losing or the star going off from the screen from not making any collisions. The draw function is also used a lot, as it’s 
         responsible for the providing of the background, player, stars, time, and game window. <br>
         ...
         the rules pygame offers.<br> 
         <b>Variables</b> - The variables used are the WIN, player width, height, velocity, the stars width, height, and velocity,
         BASE_DIR, and the font used for display. All these variables allow for the working and loads of the player and objects in the game.<br>
         <b>Information Theory</b> - While my code may not be a direct relation to info theory, there are many aspects that I would like you to look into and consider.
         This simple, very known and common 2d game represents information. As simple as that, it shows the player's position, the stars positions and 
         random they could be, the time that's put up, and etc. Another way is the information transmission. In order for the game to process, the player 
         has to press key spaces which is input! My code utilizes randomness. It's imported into the game, and the reason why this could also be considered
         is because entropy is something quite similar, which is also in information theory. The last are commmunication and the games algorithm. This game
         is able to communicate to the player with the visuauls and text displayed on this screen, and the algorithm used is quite complex meaning it can
         be more perused in the information theory terms. I know it's quite disappointing that my product isn't directly a product of information theory, 
         I still wanted to do it knowing that I could prove my knowledge through all the skills learned throughout this semester and I feel like it's quite
         understandable. Please consider the transmission, representation, processing of info., and control flow of my project. 
</i>
            <br><br>
        ...
        <tr>
          ...
          <font size="+1" color="#1A5276"><b><i>Game Design</i></b></font><br></h1>
          <blockquote>
